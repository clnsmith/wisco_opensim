...
int main()
{
    try {
		...
		//Load Model
		static const std::string model_file{ "../shared/ball_and_floor.osim" };
		...
		WISCO_ElasticFoundationForce* contactForce = new WISCO_ElasticFoundationForce(*floorMesh,*floorContactParams,*ballMesh, *ballContactParams);
