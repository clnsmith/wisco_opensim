	...
	*/
	...
	public:
		...
		*/
		...
		CollisionModel3D* updColdetModel() const;
		...
		//SimTK::Vector_<SimTK::Vec3> getTriangleCentersInGround(SimTK::State state) const;
		//SimTK::Vector_<SimTK::Vec3> getTriangleNormalsInGround(SimTK::State state) const;
		/**
	...
	private:
		...
		SimTK::Matrix ver_tri_connect;
        SimTK::Vector ver_nTri;
