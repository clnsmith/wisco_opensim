...
namespace OpenSim {
    ...
    class WISCO_ElasticFoundationForce : public Force {
        ...
        public:
            ...
            // Connectors
            //==============================================================================
            OpenSim_DECLARE_CONNECTOR(mesh1, WISCO_ContactMesh, "Contact Mesh1")
            OpenSim_DECLARE_CONNECTOR(mesh2, WISCO_ContactMesh, "Contact Mesh2")
            //==============================================================================
            // OUTPUTS
            //==============================================================================
        ...
        private:
            double computeTriProximity(CollisionModel3D* coldet_model, SimTK::Vec3 tri_cen_ground) const;
    ...
    class WISCO_ElasticFoundationForce::ContactParameters : public Object {
        OpenSim_DECLARE_CONCRETE_OBJECT(WISCO_ElasticFoundationForce::ContactParameters,
            Object)
        public:
        //==============================================================================
        // PROPERTIES
