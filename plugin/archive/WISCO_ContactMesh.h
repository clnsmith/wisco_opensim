...
namespace OpenSim {
	...
	*/
	...
	public:
		...
		OpenSim_DECLARE_PROPERTY(write_output, bool,
			"Flag to write contact output files.");

		OpenSim_DECLARE_OPTIONAL_PROPERTY(output_folder, std::string,
			"Path to folder to write contact output files.")
