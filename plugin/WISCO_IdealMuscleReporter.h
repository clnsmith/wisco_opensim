#ifndef OPENSIM_WISCO_IDEAL_MUSCLE_REPORTER_H_
#define OPENSIM_WISCO_IDEAL_MUSCLE_REPORTER_H_
/* -------------------------------------------------------------------------- *
 *                     OpenSim:  WISCO_IdealMuscleReporter.h                   *
 * -------------------------------------------------------------------------- *
 ...
 * @ingroup reporters
 */
class OSIMPLUGIN_API WISCO_IdealMuscleReporter : public ModelComponent {
OpenSim_DECLARE_CONCRETE_OBJECT(WISCO_IdealMuscleReporter, ModelComponent);
...
#endif // OPENSIM_WISCO_IDEAL_MUSCLE_REPORTER_H_
